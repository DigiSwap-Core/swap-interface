...
import { CurrencyAmount, JSBI, Token, Trade } from '@digiswap-core/sdk-v1'
import React, { useCallback, useContext, useEffect, useMemo, useState } from 'react'
// import React, { useCallback, useContext, useEffect, useMemo, useState, useRef } from 'react'
import { ArrowDown } from 'react-feather'
import { CardBody, ArrowDownIcon, Button, IconButton, Text, Link } from '@pepperswap-libs/uikit'
// import { CardBody, ArrowDownIcon, Button, IconButton, Text, useModal, Link, Flex } from '@pepperswap-libs/uikit'
